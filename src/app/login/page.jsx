      ...
      <div className="w-full max-w-7xl grid md:grid-cols-2 gap-12 items-center bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        {/* logo  */}
          ...
          <p className="text-xl md:text-2xl opacity-95 leading-relaxed">
            Discover thousands of delicious recipes, save your favorites,
          ...
          <div className="max-w-md mx-auto">
            ...
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24">
                ...
                <path fill="#EA4335" d="M12 6.75c1.63 0 3.06.56 4.21 1.65l3.15-3.15C16.81 2.61 14.46 1.5 12 1.5c-4.3 0-8.07 2.47-9.88 6.09l3.66 2.84C6.71 7.93 9.14 6.75 12 6.75z" />
              </svg>
